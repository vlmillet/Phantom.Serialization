...
PHANTOM_PACKAGE("phantom.serialization")
    PHANTOM_SOURCE("SerializerVisitor")
        ...
        .public_()
            ...
            .PHANTOM_T constructor<void(SerializerType&, uint32, bool)>()["false"]
            .PHANTOM_T method<SerializerStatus(void*, ::phantom::lang::Type *)>("visit", &_::visit)
            .PHANTOM_T method<SerializerStatus(const void*, ::phantom::lang::Type *)>("visit", &_::visit)
        ...
        .protected_()
            ...
            .PHANTOM_T method<void(InstanceT<ContainerClass>)>("clear", &_::clear)
            .PHANTOM_T method<bool(InstanceT<VectorClass>)>("traverseVectorClass", &_::traverseVectorClass)
            .PHANTOM_T method<bool(InstanceT<SetClass>)>("readSetContainer", &_::readSetContainer)
            .PHANTOM_T method<bool(InstanceT<MapClass>)>("readMapContainer", &_::readMapContainer)
            .PHANTOM_T method<bool(InstanceT<MapClass>)>("traverseMapClass", &_::traverseMapClass)
            .PHANTOM_T method<bool(InstanceT<SetClass>)>("traverseSetClass", &_::traverseSetClass)
            ...
            .PHANTOM_T method<bool(SerializerStatus)>("checkStatus", &_::checkStatus)
            ...
            .PHANTOM_T method<bool(InstanceT<VectorClass>)>("walkUpVisitFromVectorClass", &_::walkUpVisitFromVectorClass)
            .PHANTOM_T method<bool(InstanceT<VectorClass>)>("walkUpEndFromVectorClass", &_::walkUpEndFromVectorClass)
            .PHANTOM_T method<bool(InstanceT<MapClass>)>("walkUpVisitFromMapClass", &_::walkUpVisitFromMapClass)
            .PHANTOM_T method<bool(InstanceT<MapClass>)>("walkUpEndFromMapClass", &_::walkUpEndFromMapClass)
            .PHANTOM_T method<bool(InstanceT<SetClass>)>("walkUpVisitFromSetClass", &_::walkUpVisitFromSetClass)
            .PHANTOM_T method<bool(InstanceT<SetClass>)>("walkUpEndFromSetClass", &_::walkUpEndFromSetClass)
        ...
        PHANTOM_CLASS(SerializerVisitor)
        {
            this_()
        .public_()
            .constructor<void(Serializer&, uint32)>()
            ;
        }
